...
const API_HOST = paramsMainSelectedOption.value?.value;
...
const fetchGetData = async () => {
  try {
    ...
    const response = await fetch(`${paramsMainSelectedOption.value?.value}?sku=${API_SKU}`);
    ...
    <div class="slider-table">
      ...
      <div class="table-content table-tab-content" v-for="(method, index_method) in serversStore.getMethods"
        ...
        <div class="table-head">
          ...
          <span class="text">{{ method.desc }}</span>
          <button class="btn btn-pink-black" @click="handleTestEndpoint">
        ...
        <div class="table-content">
          <ul class="table-head table-tabs js_tabs">
            ...
            <li>
              ...
              :class="{ active: selectedResponseTab === 'result' }" 
              :disabled="isResultTestEndpoint !== true"
              @click="changeResponseSelectedTab('result')">
          ...
          <div class="table-tab-content" :class="{ visible: selectedResponseTab === 'result' }"
              data-id="#table-tab3">
              <div class="table-scroll-wrap with-bg">
                <div class="table-scroll">
